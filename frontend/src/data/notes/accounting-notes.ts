  ...
  pages: [
    {
      ...
      blocks: [
        { kind: "video", youtubeId: "VhwZ9t2b3Zk", title: "ACCOUNTING BASICS: Debits and Credits Explained (AccountingStuff)", caption: "Debits, credits, the accounting equation and how double entry bookkeeping keeps the books balanced" },
        ...
        { kind: "image", src: "https://upload.wikimedia.org/wikipedia/commons/6/62/Debit_vs_Credit_in_Accounting_diagram.png", caption: "Debit vs Credit in accounting: how debits and credits affect asset, liability, capital, expense and income accounts — the foundation of double-entry bookkeeping.", side: "full" },
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "image", src: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Classification_chart_of_General_Ledger_Accounts%2C_1919_%281%29.jpg/640px-Classification_chart_of_General_Ledger_Accounts%2C_1919_%281%29.jpg", caption: "Classification chart of General Ledger Accounts: the ledger organises all T-accounts into Sales Ledger (customers), Purchases Ledger (suppliers) and General Ledger (all other accounts).", side: "right" },
  ...
  pages: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "image", src: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/CBDC_stylized_Balance_Sheet_%28Digitales_Zentralbankgeld%29.png/640px-CBDC_stylized_Balance_Sheet_%28Digitales_Zentralbankgeld%29.png", caption: "A stylised balance sheet: assets on the left, liabilities + equity on the right. The two sides always balance (Assets = Liabilities + Equity), reflecting the accounting equation.", side: "right" },
  ...
  pages: [
    {
      ...
      blocks: [
        ...
        { kind: "image", src: "https://upload.wikimedia.org/wikipedia/commons/6/62/Debit_vs_Credit_in_Accounting_diagram.png", caption: "Cash and non-cash flows: only real cash inflows and outflows appear in the cash flow statement. Depreciation and accruals are excluded because no money physically changes hands.", side: "right" },
